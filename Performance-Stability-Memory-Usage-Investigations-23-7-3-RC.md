...
![](assets/image-2023-9-29_13-59-46.png)
...
It's important to note that the GC flags were activated on the 23.7.2 version on September 21st, and an automatic restart also occurred on Monday, September 25th. We observed that without the GC flags, Besu utilized up to 8.7 GiB of memory. However, once the flags were enabled, memory usage was capped at 7.5 GiB.

![](assets/image-2023-9-29_14-11-11.png)
...
![](assets/image-2023-9-29_14-39-8.png)
...
![](assets/image-2023-9-29_14-48-34.png)
...
![](assets/image-2023-9-29_15-14-4.png)
...
![](assets/image-2023-9-29_15-30-25.png)

![](assets/image-2023-9-29_15-30-48.png)
...
```
sudo jcmd PID GC.heap_dump /tmp/release-23-7-2-2-heapdump-29092023-2.hprof
Dumping heap to /tmp/release-23-7-2-2-heapdump-29092023-2.hprof ...
Heap dump file created [598758192 bytes in 3.140 secs] => 571MB
```

![](assets/image-2023-9-29_15-46-56.png)

![](assets/image-2023-9-29_15-52-24.png)
...
![](assets/image-2023-9-29_15-47-28.png)

![](assets/image-2023-10-2_20-3-10.png)
...
![](assets/image-2023-9-29_16-37-37.png)

### 4. Native allocations comparison
...
```
Off heap memory = process memory - (committed heap + committed non heap + NUMBER_OF_THREADS * 1024 * 1024)   // Xss = 1 MiB = 1024 * 1024 Bytes
```
...
![](assets/image-2023-9-29_17-38-6.png)

...
This is a template that can be used by the community to propose a new feature for Besu. If you have an idea for a feature that you would like to discuss with other contributors prior to formally proposing it, the `#besu` channel of the [LF Decentralized Trust Discord](https://discord.gg/hyperledger) is the best place to start.

...
- Change `BlockHashLookup` parameters and such to `Function<Long, Hash>`.
...
- Create EVM-focused block header interface (to support operations), possibly add to `o.h.b.plugin.data`.
  - basefee
  - blockhash (?)
  - difficulty
  - gaslimit

...
- Out of Memory errors.
  - Documentation on what kind of memory config is needed.
...
- Solution?: Instead of replaying each time the traces for each user request why not save this trace result in a separate database or a separate module instead of saving the block and the worldstate for each block.
